...
Como bien se ve en el gráfico, no se observa ningún quiebre. La performance transita por sobre el número 350 suavemente y siguiendo la tendencia anterior. Atribuimos esto, como dijimos antes, a las poderosas tecnologías que incorporan los procesadores modernos para prefetchear datos de memoria. Los nombres que les pone Intel a estos ingredientes en su microarquitectura son  ``Smart Memory Access'' y ``Advanced Smart Cache''.
